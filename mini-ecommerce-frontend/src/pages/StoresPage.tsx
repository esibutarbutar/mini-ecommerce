...
const StoresPage: React.FC = () => {
  ...
  return (
  <div className="responsive-container" style={{ maxWidth: 900, margin: '2rem auto', background: '#fff', borderRadius: 12, boxShadow: '0 2px 8px rgba(0,0,0,0.07)', padding: '2rem' }}>
